...
const columns = [
  { id: 'name', label: 'Menu Name', minWidth: 250, align: 'left' },
  { id: 'view', label: 'View', minWidth: 50, align: 'center' },
  { id: 'add', label: 'Add', minWidth: 50, align: 'center' },
...
export default function StickyHeadTable({ data }) {
    ...
    const rows = data.map((ele, index) =>
        createData(index, ele.FileName, ele.RoleView, ele.RoleAdd, ele.RoleEdit, ele.RoleDelete)
    );
