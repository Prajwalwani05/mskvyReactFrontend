...
const Dashboard = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await axios.get(`${apiUrl}/api/AdminDashboardForSPV`, {
        params: {
          PPA_Referance_No: decryptedObject.PPA_Referance_No,
              ...
              {dasboard?.Model?.SPVDetails_By_Dashboard ? (
                <>
                  ...
                  >
                    ...
                    <Typography variant="body2">
                      {dasboard.Model.SPVDetails_By_Dashboard?.SolarCapacity ||
                        "N/A"}
                    </Typography>
                  </Box>
                  <Box display={"flex"} mb={1} justifyContent={"space-between"}>
